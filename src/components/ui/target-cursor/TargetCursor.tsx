...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const scrollHandler = () => {
      ...
      const mouseX = parseFloat(gsap.getProperty(cursorRef.current, 'x') as string);
      const mouseY = parseFloat(gsap.getProperty(cursorRef.current, 'y') as string);
      ...
      const leaveHandler = () => {
        ...
        resumeTimeout = setTimeout(() => {
          if (!activeTarget && cursorRef.current && spinTl.current) {
            const currentRotation = parseFloat(gsap.getProperty(cursorRef.current, 'rotation') as string);
